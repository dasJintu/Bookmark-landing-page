...
const Footer = () => {
  return (
    <footer className="bg-very-dark-blue text-white py-10">
      <div className="container">
        <div className="flex flex-col md:flex-row gap-8 justify-between items-center">
          <div className="flex-1 flex flex-col items-center md:flex-row gap-10">
            ...
            <ul className="uppercase  flex flex-col items-center md:flex-row gap-10">
              <li>Features</li>
              <li>Pricing</li>
              <li>Contact</li>
            </ul>
          ...
          <div className="flex-1 flex gap-10 justify-end">
            <i
              ...
              aria-hidden="true"
            ></i>
            <i className="text-2xl fa fa-twitter" aria-hidden="true"></i>
          </div>
        </div>
      </div>
    </footer>
